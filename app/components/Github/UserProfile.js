...
class UserProfile extends React.Component {
  render () {
    return (
      ...
      {this.props.bio.username && <li className="list-group-item">Username: {this.props.bio.login} </li>}
      ...
      {this.props.bio.company && <li className="list-group-item">Company: {this.props.bio.comapny} </li>}
      ...
      {this.props.bio.public_repos && <li className="list-group-item">Repos: {this.props.bio.public_repos} </li>}
